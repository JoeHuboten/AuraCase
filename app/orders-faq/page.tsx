    ...
    cancellation: [
      {
        ...
        answer: "Можете да отмените поръчка в рамките на 2 часа от направената поръчка, при условие че тя все още не е изпратена. Свържете се с нас на support@auracase.bg."
      },
      {
