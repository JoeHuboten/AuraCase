...
Платформата AuraCase е проектирана с принципа за вградена сигурност, където защитата е интегрирана във всеки аспект на системата, а не добавена като допълнителен слой. Този подход гарантира, че сигурността е последователна и всеобхватна.

В тази глава ще разгледаме различните аспекти на сигурността в AuraCase, включително управлението на достъпа, защитата на данните, валидацията на входящата информация, ограничаването на заявките и мониторинга на системата.
...
В AuraCase съществуват две основни роли за регистрирани потребители. Обикновените потребители имат достъп до клиентските функционалности като разглеждане на каталога, управление на количката, извършване на поръчки, писане на отзиви и управление на профила. Администраторите имат пълен достъп до всички функционалности, включително административния панел за управление на продукти, поръчки, потребители и системни настройки.
...
Автентикацията е процесът на потвърждаване на самоличността на потребителя. В AuraCase тя се осъществява чрез имейл адрес и парола, като паролата се сравнява с хешираната версия, съхранена в базата данни.
...
AuraCase използва библиотеката Zod за дефиниране на схеми и валидация на данни. Zod позволява декларативно описание на структурата, типовете и ограниченията на данните. При несъответствие се генерира подробна информация за грешката, която помага на клиентската страна да покаже полезно съобщение на потребителя.
...
Уеб приложенията са изложени на редица добре познати атаки и AuraCase включва защити срещу всяка от тях.
...
Логирането е съществен инструмент за наблюдение на системата, откриване на проблеми и разследване на инциденти. AuraCase включва структурирана система за логиране, която записва важни събития и информация.
...
Тестването е критична част от процеса на разработка, която осигурява коректността и надеждността на кода. AuraCase използва рамката Vitest за автоматизирано тестване.
...
Сигурността и качеството са неразделни аспекти на платформата AuraCase. Многопластовата защита обхваща управление на достъпа, сигурна автентикация, валидация на данни, ограничаване на заявки и защити срещу специфични атаки.
